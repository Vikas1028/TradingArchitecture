...
// resolveDataFilePath searches common application-relative locations for one data file.
...
// resolveTokenGroupFilePath searches known stock basket locations for a token group CSV.
...
// augmentTokenMapFromBasket backfills missing token-master entries from a basket CSV.
